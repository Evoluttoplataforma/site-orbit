// Full content including footer and scripts - from site/consultores.html
export const pageHTML = `
    ...
    <section class="lp-section lp-section--dark">
        <div class="lp-container">
            <div class="lp-section-header" data-reveal>
                <span class="lp-badge">O time que você oferece ao seu cliente</span>
                <h2>12 agentes especializados.<br>Coordenados pela <span style="color:#ffba1a;">Olívia</span>.</h2>
            </div>

            <div class="orbit-hub" id="orbitHub3">
                ...
                <svg class="orbit-hub__lines" id="orbitLines3"></svg>
            ...
            <div style="text-align:center;margin-top:48px;padding-top:32px;border-top:1px solid rgba(255,255,255,0.06);" data-reveal>
                <p style="color:rgba(255,255,255,0.5);font-size:1rem;">Cada agente trabalha 24/7. Não tira férias. Não pede aumento.</p>
            </div>

            <script>
            (function() {
                var hub = document.getElementById('orbitHub3');
                if (!hub) return;
                var TOTAL = 12;
                var nodes = hub.querySelectorAll('.orbit-hub__node');
                var svg = document.getElementById('orbitLines3');
                ...
                function layout() {
                    ...
                    defs.innerHTML = '<filter id="lineGlow3"><feGaussianBlur stdDeviation="3" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>';
                    ...
                    nodes.forEach(function(node, i) {
                        ...
                        line.setAttribute('filter', 'url(#lineGlow3)');
                        svg.appendChild(line);

                        var circle = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
                        circle.setAttribute('r', '3.5');
                        circle.setAttribute('fill', '#ffca4a');
                        circle.setAttribute('filter', 'url(#lineGlow3)');
                        ...
                        pathEl.setAttribute('id', 'cn-orbit-path-' + i);
                        pathEl.setAttribute('d', 'M' + nx + ',' + ny + ' L' + cx + ',' + cy);
                        pathEl.setAttribute('fill', 'none');
                        defs.appendChild(pathEl);
                        path.setAttributeNS('http://www.w3.org/1999/xlink', 'href', '#cn-orbit-path-' + i);
