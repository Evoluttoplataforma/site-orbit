...
export const pageHTML = `
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ctaBannerCtaUrl" placeholder="URL destino" value="https://demonstracao.orbitgestao.com.br/chat">
                                </div>
                                <div class="form-group">
    ...
    function clearEditor() {
        ...
        document.getElementById('ctaBannerCtaUrl').value = 'https://demonstracao.orbitgestao.com.br/chat';
    ...
    async function editArticle(id) {
        ...
        document.getElementById('ctaBannerCtaUrl').value = article.cta_banner_cta_url || 'https://demonstracao.orbitgestao.com.br/chat';
    ...
    async function saveArticle(status) {
        ...
        var articleData = {
            ...
            cta_banner_cta_url: ctaBannerCtaUrl || 'https://demonstracao.orbitgestao.com.br/chat',
...
'                <li><a href="https://demonstracao.orbitgestao.com.br/chat">Fale Conosco</a></li>' +
'            </ul>' +
'            <div class="nav-actions">' +
'                <a href="#" class="btn btn-outline" data-i18n="nav.login">Entrar</a>' +
'                <a href="https://demonstracao.orbitgestao.com.br/chat" class="btn btn-primary">Agendar Demo</a>' +
'            </div>' +
...
'                <span class="lang-switch__label">EN</span>' +
'            </button>' +
'            <a href="https://demonstracao.orbitgestao.com.br/chat" class="btn btn-primary" onclick="closeMobileMenu()">Fale Conosco</a>' +
'        </div>' +
'    </div>' +
...
'            <a href="https://demonstracao.orbitgestao.com.br/chat" class="btn btn-primary btn-lg">Agendar demonstracao</a>' +
'        </div>' +
'    </section>' +
'    <footer class="footer">' +
'        <div class="container">' +
