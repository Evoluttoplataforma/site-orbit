            ...
            <div class="footer-grid">
                ...
                <div class="footer-column">
                    ...
                    <div style="display:flex;flex-direction:column;gap:10px;margin-top:12px;">
                        <a href="https://wa.me/554898149776" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;background:#25D366;color:#fff;padding:10px 18px;border-radius:50px;font-size:14px;font-weight:600;text-decoration:none;transition:opacity 0.2s;"><i class="fab fa-whatsapp" style="font-size:18px;"></i> (48) 9814-9776</a>
                        <a href="mailto:contato@orbitgestao.com.br" style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,186,26,0.12);color:#ffba1a;padding:10px 18px;border-radius:50px;font-size:14px;font-weight:600;text-decoration:none;border:1px solid rgba(255,186,26,0.3);transition:opacity 0.2s;"><i class="fas fa-envelope" style="font-size:16px;"></i> contato@orbitgestao.com.br</a>
                    </div>
                    <p style="color:rgba(255,255,255,0.4);font-size:13px;margin-top:12px;"><i class="fas fa-map-marker-alt" style="margin-right:6px;"></i>Square SC, Florianópolis - SC</p>
                </div>
