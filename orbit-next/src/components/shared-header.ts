...
export const headerHTML = `
                    ...
                    <div class="dropdown dropdown--sm">
                        <div class="dropdown__links">
                            <a href="/live">
                                ...
                                <div class="dd-text"><span>Live Orbit</span><small>Pr&oacute;xima edi&ccedil;&atilde;o em breve</small></div>
                            </a>
                            <a href="/live/chris">
    ...
    <div class="mobile-menu">
        ...
        <div class="mobile-menu__body">
            ...
            <a href="/live"><i class="fa-solid fa-video" style="color:#2D8CFF;"></i> Live Orbit</a>
