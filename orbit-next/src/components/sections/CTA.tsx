    ...
    <section className="py-24 bg-light-bg text-center">
      <div className="max-w-[720px] mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="https://demonstracao.orbitgestao.com.br/chat" className="px-7 py-3.5 text-light-text font-semibold border border-[#D1D5DB] rounded-full hover:border-light-text hover:bg-black/[0.04] transition-all">
            {t('secondary')}
          </Link>
        </div>
      </div>
