...
function applyEnglish() {
  var t = {
    ...
    'Não é mais um software. São Dezenas de agentes de IA especializados - liderados pela': "It's not another software. Dozens of specialized AI agents - led by",
    ...
    // === ENVIAR HISTÓRIA (form) ===
    'Histórias de Clientes': 'Customer Stories',
    'com a Orbit': 'with Orbit',
    'Sua experiência pode inspirar outras empresas a transformarem sua gestão. Compartilhe como a Orbit Gestão fez a diferença no seu negócio.': 'Your experience can inspire other companies to transform their management. Share how Orbit Management made a difference in your business.',
    'Informações Pessoais': 'Personal Information',
    'Dados de contato para identificação': 'Contact details for identification',
    'Nome completo': 'Full name',
    'Cargo / Função': 'Position / Role',
    'Empresa': 'Company',
    'Segmento da empresa': 'Company segment',
    ...
    'Links opcionais para enriquecer sua história': 'Optional links to enrich your story',
    'Website da empresa': 'Company website',
    'Sua História': 'Your Story',
    'Conte em detalhes como a Orbit impactou sua empresa': 'Tell in detail how Orbit impacted your company',
    'Título da sua história': 'Title of your story',
    'Qual era o desafio antes da Orbit?': 'What was the challenge before Orbit?',
    'Como a Orbit ajudou a resolver?': 'How did Orbit help solve it?',
    'Quais resultados alcançados?': 'What results were achieved?',
    'Depoimento livre / Mensagem adicional': 'Free testimonial / Additional message',
    'Quais módulos utiliza?': 'Which modules do you use?',
    'Mídia': 'Media',
    'Fotos, vídeos e logo para ilustrar sua história': 'Photos, videos and logo to illustrate your story',
    'Upload de fotos': 'Photo upload',
    'até 5 imagens, máx. 2MB cada': 'up to 5 images, max 2MB each',
    'Arraste fotos aqui ou clique para selecionar': 'Drag photos here or click to select',
    'URL de vídeo do YouTube ou Vimeo': 'YouTube or Vimeo video URL',
    'Logo da empresa': 'Company logo',
    'opcional, máx. 2MB': 'optional, max 2MB',
    'Arraste o logo aqui ou clique para selecionar': 'Drag the logo here or click to select',
    'Remover': 'Remove',
    'Autorizo a Orbit Gestão a publicar minha história no site, incluindo nome, empresa e imagens enviadas.': 'I authorize Orbit Management to publish my story on the website, including name, company and uploaded images.',
    'Você precisa autorizar para enviar': 'You must authorize to submit',
    'Enviar minha história': 'Submit my story',
    'História enviada com sucesso!': 'Story submitted successfully!',
    'Obrigado por compartilhar sua experiência. Nossa equipe irá revisar sua história e em breve ela poderá ser publicada no site.': 'Thank you for sharing your experience. Our team will review your story and it may be published on the site soon.',
    'Ver Histórias': 'View Stories',
    ...
    'Nasce a Olívia e dezenas de agentes': 'Olívia and dozens of agents are born',
    ...
    'A IA é integrada à gestão. Olívia coordena dezenas de agentes especializados que operam 24/7 nas empresas. Consultoria recorrente, automatizada e acessível.': 'AI is integrated into management. Olívia coordinates dozens of specialized agents that operate 24/7 in companies. Recurring, automated and accessible consulting.',
    ...
    // === "DEZENAS" UPDATES (HTML changed from 12 to dezenas) ===
    'Dezenas de agentes de IA trabalham por você': 'Dozens of AI agents work for you',
    'Mapeiam processos, monitoram indicadores, treinam equipes. Sem parar.': 'They map processes, monitor KPIs, train teams. Non-stop.',
    'A operação não para quando o projeto acaba. Os agentes continuam trabalhando 24/7.': "Operations don't stop when the project ends. Agents keep working 24/7.",
    'Dezenas de agentes especializados prontos para operar nos seus clientes.': 'Dozens of specialized agents ready to operate on your clients.',
    'dezenas de agentes operando': 'dozens of agents operating',
    'dezenas de agentes especializados': 'dozens of specialized agents',
    'Seu time de IA coordenado pela Olívia': 'Your AI team coordinated by Olívia',
    'Conecta todos os dados': 'Connects all data',
    'Traduz em decisão': 'Translates into decisions',
    'Dezenas de especialistas. 1 coordenadora. Custo de 1 funcionário.': 'Dozens of specialists. 1 coordinator. Cost of 1 employee.',
    '+2.900': '+2,900',

    // === EMPRESARIOS - Reframe section ===
    'Por que software sozinho não resolve?': "Why doesn't software alone solve it?",
    'Software não é ruim.': "Software isn't bad.",
    'O problema é outro.': 'The problem is something else.',
    'Mesmo depois de parametrizar, o software não entrega tudo que você precisa. Porque ele depende de você preencher tudo — e ninguém preenche.': "Even after setting it up, software doesn't deliver everything you need. Because it depends on you filling everything in — and nobody does.",
    'Comprou software': 'Bought software',
    'Precisa alimentar manualmente. Ninguém alimenta. Vira shelfware.': 'Requires manual input. Nobody inputs. Becomes shelfware.',
    'Investiu meses em padronização': 'Invested months in standardization',
    'Criou processos, manuais, fluxogramas. Ninguém seguiu. Virou documento morto.': 'Created processes, manuals, flowcharts. Nobody followed. Became dead documents.',
    'Teve que voltar a usar planilhas': 'Had to go back to spreadsheets',
    'O software não entregou tudo. A planilha voltou. E ninguém confia nos dados.': "Software didn't deliver everything. Spreadsheets came back. And nobody trusts the data.",
    'O ciclo se repete': 'The cycle repeats',
    'Mais uma ferramenta abandonada. Mais dinheiro desperdiçado.': 'Another abandoned tool. More money wasted.',
    'E se existisse outro caminho?': 'What if there were another way?',
    'Aprovado': 'Approved',
    'Ajustado': 'Adjusted',
    'Funciona 24/7, mesmo sem você': 'Works 24/7, even without you',
    'Operando agora': 'Operating now',

    // === EMPRESARIOS - Testimonials ===
    'Empresários que já usam Orbit': 'Business owners already using Orbit',
    'Veja como empresas como a sua estão transformando a gestão com o Orbit.': 'See how companies like yours are transforming management with Orbit.',

    // === EMPRESARIOS - Cost comparison ===
    'Quanto custa não ter um time estratégico?': "How much does it cost not to have a strategic team?",
    'Compare o custo de montar esse time manualmente versus usar o Orbit.': 'Compare the cost of building this team manually vs. using Orbit.',
    'Montar esse time manualmente': 'Building this team manually',
    'Consultor estratégico': 'Strategic consultant',
    'Analista de processos': 'Process analyst',
    'Analista DHO': 'HR analyst',
    ...
    'R$ 1.200/mês': 'R$ 1,200/month',
    'Coordenado pela Olívia (IA)': 'Coordinated by Olívia (AI)',
    'Sem contratação CLT': 'No CLT hiring',
    'Operação imediata': 'Immediate operations',
    'Ver planos completos': 'See full plans',

    // === CONSULTORES - Hero section ===
    'Pare de vender projeto.': 'Stop selling projects.',
    'Comece a vender': 'Start selling',
    'operação de IA': 'AI operations',
    'gera recorrência.': 'generates recurrence.',
    'escala.': 'scales.',
    'retém.': 'retains.',
    'Transforme consultoria recorrente passiva pontual em operação recorrente. Seus clientes ficam, sua receita cresce, dezenas de agentes de IA trabalham 24/7 — coordenados pela': 'Transform one-time consulting into recurring operations. Your clients stay, your revenue grows, dozens of AI agents work 24/7 — coordinated by',
    'consultorias ativas': 'active consultancies',
    'margem white-label': 'white-label margin',
    'operação contínua': 'continuous operations',
    'QUERO SER UMA PLATAFORMA DE IA': 'I WANT TO BE AN AI PLATFORM',
    'CONSULTORIAS ATIVAS': 'ACTIVE CONSULTANCIES',
    'MARGEM WHITE-LABEL': 'WHITE-LABEL MARGIN',
    'OPERAÇÃO CONTÍNUA': 'CONTINUOUS OPERATIONS',

    // === CONSULTORES - Business model section ===
    'O ciclo que mata sua receita': 'The cycle that kills your revenue',
    'Compare o modelo antigo com a operação Orbit.': 'Compare the old model with Orbit operations.',
    'Modelo Antigo': 'Old Model',
    'Baseado em projeto': 'Project-based',
    'Escopo fechado, sem expansão': 'Closed scope, no expansion',
    'Entrega e encerramento': 'Delivery and closure',
    'Cliente recebe o material e o contrato acaba': 'Client receives the material and the contract ends',
    'Churn inevitável': 'Inevitable churn',
    'Começar do zero': 'Starting from zero',
    'Ciclo eterno': 'Eternal cycle',
    'Projeto + IA': 'Project + AI',
    'Seu método + ativação dos agentes na entrega': 'Your method + agent activation on delivery',
    'Agentes seguem executando após a entrega': 'Agents keep executing after delivery',
    'Cliente paga porque IA continua gerando valor': 'Client pays because AI keeps generating value',
    'Ative novos agentes sem venda nova': 'Activate new agents without a new sale',
    'Receita previsível, margem ~60%, crescimento composto': 'Predictable revenue, ~60% margin, compound growth',

    // === CONSULTORES - Math / Calculator ===
    'A matemática que muda tudo': 'The math that changes everything',
    'de margem para você': 'margin for you',
    'sua marca, sua operação': 'your brand, your operations',
    'Simule sua receita recorrente': 'Simulate your recurring revenue',
    'Preencha os campos e veja quanto você pode faturar com o Orbit.': 'Fill in the fields and see how much you can earn with Orbit.',
    'Quantos clientes ativos pretende ter?': 'How many active clients do you plan to have?',
    'Qual o valor da mensalidade da sua consultoria?': "What's the monthly fee for your consulting?",
    'Margem estimada (~60%)': 'Estimated margin (~60%)',
    'MARGEM ESTIMADA (~60%)': 'ESTIMATED MARGIN (~60%)',

    // === CONSULTORES - Partner benefits ===
    'O que você ganha como parceiro': 'What you gain as a partner',
    'Agentes operando': 'Agents operating',
    'Agentes trabalham 24/7 no cliente. Você recebe todo mês, mesmo sem estar presente. Consultoria recorrente passiva.': 'Agents work 24/7 on the client. You get paid every month, even without being present. Passive recurring consulting.',
    'Sua marca, seu relacionamento. O cliente é seu do início ao fim.': 'Your brand, your relationship. The client is yours from start to finish.',
    'Lock-in Natural': 'Natural Lock-in',
    'Quanto mais o cliente usa, mais depende. Churn próximo de zero.': 'The more the client uses it, the more they depend on it. Churn close to zero.',
    'Suporte Dedicado': 'Dedicated Support',
    'Onboarding, materiais de venda, treinamento e suporte técnico inclusos.': 'Onboarding, sales materials, training and technical support included.',
    'Agentes Customizáveis': 'Customizable Agents',
    'Construa um agente uma vez — ele duplica seu método para outros clientes.': 'Build an agent once — it duplicates your method for other clients.',
    'Sem Risco Financeiro': 'No Financial Risk',
    'Nós operamos a plataforma. Você foca em vender e coordenar.': 'We operate the platform. You focus on selling and coordinating.',

    // === CONSULTORES - Roadmap ===
    'E isso é só o começo': 'And this is just the beginning',
    'O presente: agentes customizáveis': 'The present: customizable agents',
    'Ativo agora': 'Active now',
    'Agora': 'Now',
    ...
    'Gerar agente': 'Generate agent',
    'canais ativos': 'active channels',
    '30+ consultorias já estão ganhando com IA. Sua vez.': '30+ consultancies are already winning with AI. Your turn.',

    // === CONSULTORES - FAQ ===
    'Meus clientes são pequenos, vão pagar?': 'My clients are small, will they pay?',
    'E se o Orbit não atender minha metodologia?': "What if Orbit doesn't fit my methodology?",
    'Vou poder criar meus próprios agentes?': 'Will I be able to create my own agents?',
    'Qual o investimento?': "What's the investment?",

    // === SOBRE PAGE - dezenas updates ===
    'Diretor de Produto. Lidera o desenvolvimento da plataforma e a evolução dos dezenas de agentes de IA.': 'Director of Product. Leads the platform development and the evolution of dozens of AI agents.',
    'Agende uma demonstração gratuita e veja como dezenas de agentes de IA podem transformar a gestão da sua empresa.': "Schedule a free demo and see how dozens of AI agents can transform your company's management.",
  ...
  var i18nMap = {
    ...
    'nav.program': 'Rewards Program', 'nav.program.sub': 'Orbit Growth & Recognition Program',
    ...
    // ─── NAV gerada por src/components/nav-data.ts ───
    // Toda chave usada lá precisa existir aqui, senão o item fica em PT no modo EN.
    // Os valores dos agentes/módulos batem com o dicionário `t` de propósito: a
    // mesma palavra traduzida de dois jeitos na mesma página é pior que não traduzir.
    'nav.events': 'Events',
    'nav.agents_head': 'Olívia Team · 12 agents',
    'nav.agents_head.sub': 'Overview · 30 years of GSN methodology',
    'nav.agents_all': 'See the full Olívia Team',
    'nav.agents_list': 'The 12 agents',
    'nav.modules_head': 'Platform modules',
    'nav.modules_head.sub': '4 integrated operational modules',
    'nav.modules_all': 'See all modules',
    'nav.modules_list': 'The 4 modules',
    'nav.ag.estrategico': 'Strategy',
    'nav.ag.riscos': 'Risks',
    'nav.ag.processos': 'Processes',
    'nav.ag.treinamento': 'Training',
    'nav.ag.pessoas': 'People',
    'nav.ag.oportunidades': 'Opportunities',
    'nav.ag.indicadores': 'Indicators',
    'nav.ag.documentos': 'Documents',
    'nav.ag.comercial': 'Sales',
    'nav.ag.reunioes': 'Meetings',
    'nav.ag.problemas': 'Problems',
    'nav.ag.pesquisas': 'Surveys',
    'nav.mod.financeiro': 'Finance',
